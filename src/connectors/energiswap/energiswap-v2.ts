...
import IEnergiswapPair from '@energi/energiswap-contracts/contracts/energiswapPair/EnergiswapPairProxy.sol';
...
export class Energiswap implements Energiswapish {
  ...
  //private chain: Energi | BinanceSmartChain | Polygon;
  ...
  async fetchData(baseToken: Token, quoteToken: Token): Promise<Pair> {
    const pairAddress = Pair.pairAddress(baseToken, quoteToken);
