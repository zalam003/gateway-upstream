...
// information about an Energi token
...
export class EnergiBase {
  ...
  // energi token lists are large. instead of reloading each time with
  ...
  // returns an energi TransactionResponse for a txHash.
  ...
  // returns an energi TransactionReceipt for a txHash if the transaction has been mined.
